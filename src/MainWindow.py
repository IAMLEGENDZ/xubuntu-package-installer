...
locale.bindtextdomain('xubuntu-package-installer', '/usr/share/locale')
locale.textdomain('xubuntu-package-installer')
...
class MainWindow(object):
    def __init__(self, application, file):
        ...
        try:
            ...
            pass
        self.about_dialog.set_program_name(_("Xubuntu Package Installer"))
        if self.about_dialog.get_titlebar() is None:
            about_headerbar = Gtk.HeaderBar.new()
            about_headerbar.set_show_close_button(True)
            about_headerbar.set_title(_("About Xubuntu Package Installer"))
            about_headerbar.pack_start(Gtk.Image.new_from_icon_name("xubuntu-package-installer", Gtk.IconSize.LARGE_TOOLBAR))
        ...
        if self.notificationstate:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        pixbuf = Gtk.IconTheme.get_default().load_icon("xubuntu-package-installer", 64,
                                                                       Gtk.IconLookupFlags(16))
                    except:
                        try:
                            pixbuf = parduspixbuf.load_icon("xubuntu-package-installer", 64, Gtk.IconLookupFlags(16))
                        except:
